...
- **próximo-step-concreto:** dispatch Planner Phase 7a (Metrics Instrumentation: dashboard emits request_hit_rate + token_cache_coverage + p50/p99_latency_ms + working_set_mb, atualizado a cada N=10 requests ou T=60s. Pode começar após Phase 5b + Phase 6b; proxy T-14 fast-agent scheduling também é candidato aqui)
