...
date: 2026-07-30
version: 1
explanation: Imported from affaan-m/ecc (MIT). Expert TypeScript/JavaScript code reviewer specializing in type safety, async correctness, Node/web security, and idiomatic patterns.
---
